...
- After compaction: read `AGENTS.md`/`CLAUDE.md`, check `specs/`, run
  ...
  `/Users/alexmosquera/workspace/personal/squadai/.claude/skills/shared/context-discipline/SKILL.md`.

## Skill Resolution

Load the phase skill from `/Users/alexmosquera/workspace/personal/squadai/.claude/skills` at phase start and cache it for
