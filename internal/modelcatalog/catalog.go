...
// Approx marks encodings that are a proxy for the family's real tokenizer
// (e.g. counting Claude or Gemini text with o200k_base): counts made with
// them must be presented as estimates, never as exact.
