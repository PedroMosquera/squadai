...
//go:embed all:memory all:standards all:copilot all:skills all:teams all:mcp all:workflows all:commands all:agents all:hooks all:projectmemory all:brand all:models all:efficiency
var FS embed.FS
